 ...
 * @author sbn
 */
public class ALLTemplateExtractorFormat2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File myFile = new File("C://PIVOTData/1715/CCIA");
        ...
        while (moreTreatments) {
            ...
            if (!NULL_CELL.equals(armTesting) && !armTesting.isBlank()) {
                ...
                for (int mouse = 0; mouse < 10; mouse++) {
                    ...
                    String codes = getValue(sheet.getRow(row + mouse).getCell(23));
                    String footNote = getValue(sheet.getRow(row + mouse).getCell(24));
                    String deathDate = getDateValue(sheet.getRow(row + mouse).getCell(25));
