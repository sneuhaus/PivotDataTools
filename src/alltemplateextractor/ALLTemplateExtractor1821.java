 ...
 * @author sbn
 */
public class ALLTemplateExtractor1821 {
    ...
    static final String[] columnNames = {"record_id", "record_description", "panel_code", "testing", 
        ...
        "day_0", "arm", "arm_testing","pdxid", "all_mouse", "date_of_bleed", 
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File myFile = new File("C://PIVOTData/1821/CCIA");
        ...
        while (moreTreatments) {
            ...
            if (!NULL_CELL.equals(armTesting) && !armTesting.isBlank()) {
                ...
                for (int mouse = 0; mouse < 10; mouse++) {
                    ...
                    String pdxID = getValue(sheet.getRow(row + mouse).getCell(4));
                    String mouseName = getValue(sheet.getRow(row + mouse).getCell(5));
                    String codes = getValue(sheet.getRow(row + mouse).getCell(26));
                    String footNote = getValue(sheet.getRow(row + mouse).getCell(27));
                    String deathDate = getDateValue(sheet.getRow(row + mouse).getCell(28));
