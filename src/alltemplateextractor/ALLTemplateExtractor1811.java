 ...
 * @author sbn
 */
public class ALLTemplateExtractor1811 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File myFile = new File("C://PIVOTData/1811/CCIA");
...
//                System.out.println("inconsistant mice rows expecting treatment at row"+ i);
//            }
//        }
//        fileMiceRows.put(fileName,miceRows+"");
        ...
        while (moreTreatments) {
            ...
            if (!NULL_CELL.equals(armTesting) && !armTesting.isBlank()) {
                ...
                for (int mouse = 0; mouse < 30; mouse++) {
                    ...
                    model = getValue(sheet.getRow(row+mouse).getCell(4));
